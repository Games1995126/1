...
settings = {
    ...
    "man2":"ตั้งข้อความ",
    "man3":"ตั้งข้อความ",
    "message":"บัญชีนี้ได้การป้องกัน💢โดย ปธนกเพลิง Bot Self ระบบได้ทำการบล็อคคุณอัตโนมัติ\nติดต่อปธได้ที่ line://ti/p/~5G2020",
...
def myhelp():
    myHelp = """ 🔯టನ.ღњ.のລัບ✯Њ∏ເшิa७ຮุ่ꪊ1🔯
🚨คำสั่ง = คำสั่ง
...
🔱 🔱టನ.ღњ.のລัບ✯Њ∏ເшิa७ຮุ่ꪊ1🔱🔱"""
    return myHelp

def listgrup():
    listGrup =  """💢คำสั่งตั้งค่า టನ.✯Њ∏ເшิa७ຮุ่ꪊ1💢
...
def socmedia():
    socMedia = """💌คำสั่งแทค టನ✯Њ∏ເшิa७ຮุ่ꪊ1💌
⭐คท @ ➠ แทคคนที่จะเอาคท
⭐มิด @  ➠ ลงmidคนอื่น
⭐ชื่อ @ ➠ ลงชื่อคนอื่น
⭐ตัส @ ➠ ลงตัสคนอื่น
...
def helpset():
    helpSet = """🔱🔱คำสั่ง టನ✯Њ∏ເшิa७ຮุ่ꪊ1🔱🔱
🛂 คท  ➠ คอนแทคเอ็ม
🛂 มิด  ➠ MID เรา
🛂 ชื่อ  ➠ ชื่อเรา
🛂 ตัส  ➠ สถานะเรา
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, " BotSelfกำลังโหลด:▒...0%")
                    line.sendMessage(to, "11... 10.0%")
                    line.sendMessage(to, "2222... 20.0%")
                    line.sendMessage(to, "33333... 30.0%")
                    line.sendMessage(to, "4444444... 40.0%")
                    line.sendMessage(to, "555555555... 50.0%")
                    line.sendMessage(to, "66666666666... 60.0%")
                    line.sendMessage(to, "7777777777777... 70.0%")
                    line.sendMessage(to, "888888888888888... 80.0%")
                    line.sendMessage(to, "99999999999999999... 90.0%")
                    line.sendMessage(to, "10101010101010101010..100.0%")
                    line.sendMessage(to, " 🔱 BotSelf ยังอยู่ครับ✔")
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "ub6b210cb7ba467544a40126cb867f6fb")
                elif text.lower() == 'มิด':
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"ขำด้วย!!. อิอิ😝😝")				
